...
def RestartBrowser():
    ...
    while True:
        try:
            ...
            chromedriver = 'D:/KDD_BOWEI/crawler_2/msn/chromedriver'
...
def StartCollectMSNAd():
    ...
    collecting_webpage_urls =  load_seed_urls('./msn_seed_urls.txt') # set seed url
...
if __name__ == '__main__':
    os.chdir('D:/KDD_BOWEI/crawler_2/msn')
    StartCollectMSNAd()
